      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className={`${styles.headerBg} px-4 pt-12 pb-8 text-white`}>
          <button
            ...
            className={`${styles.backColor} font-bold text-sm flex items-center gap-1 mb-4 opacity-90`}
          >
            ← {topic.name}
          </button>
          <h1 className="text-2xl font-black">🔊 Nghe &amp; Chọn Hình</h1>
        </div>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className={`${styles.headerBg} px-4 pt-12 pb-6 text-white`}>
        <button
          onClick={() => router.push(backUrl)}
          className={`${styles.backColor} font-bold text-sm flex items-center gap-1 mb-3 opacity-90`}
        >
          ← {topic.name}
        </button>
