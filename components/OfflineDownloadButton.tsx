...
import { useOfflineDownload } from '@/lib/useOfflineDownload'
...
export default function OfflineDownloadButton({ book, topicId, topicName, downloadedCount, downloadLimit, className = '' }: Props) {
  const { state, download, remove } = useOfflineDownload(book, topicId)
