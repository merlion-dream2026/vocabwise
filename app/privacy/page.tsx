      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 space-y-6 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p>IELTS CHAMPION ("chúng tôi") vận hành ứng dụng VocabKids Pro và cam kết bảo vệ quyền riêng tư của người dùng. Chính sách này mô tả cách chúng tôi thu thập, sử dụng và bảo vệ thông tin của bạn khi sử dụng Dịch vụ.</p>
          </section>
